...
class WallpaperView(ft.Column):
    ...
    def render(self):
        ...
        self.score_check = ft.Checkbox(label="Show Daily Score & Streak", value=(settings["show_score"] == "true"))
        self.xp_check = ft.Checkbox(label="Show Level & XP Progress Bar", value=(settings["show_xp_bar"] == "true"))
        self.quests_check = ft.Checkbox(label="Show Active Quests / To-Dos", value=(settings["show_quests"] == "true"))
        ...
        content_card = ft.Container(
            content=ft.Column([
                ...
                ft.Row([self.score_check, self.xp_check, self.quests_check], spacing=25),
            ], spacing=10),
            bgcolor=ft.Colors.SURFACE_CONTAINER_HIGHEST,
            border_radius=10,
            padding=20,
